...
class DetectionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var accessoryName = accessoryList?[(indexPath as NSIndexPath).row].name
    ...
    @objc func accessoryDidConnect(_ notificaton: Notification) {
        let connectedAccessory = (notificaton as NSNotification).userInfo![EAAccessoryKey]
    ...
    @objc func accessoryDidDisconnect(_ notification: Notification) {
        let disconnectedAccessory = (notification as NSNotification).userInfo![EAAccessoryKey] as AnyObject
